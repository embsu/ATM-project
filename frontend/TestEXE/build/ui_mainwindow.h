...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonOpen->setGeometry(QRect(120, 80, 151, 61));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(100, 40, 211, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "PRESS OPEN TO ENTER THE PINCODE", nullptr));
    } // retranslateUi
